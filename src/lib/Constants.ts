...
export const polygonIndicatorLabels: { [key: string]: string } = {
  pop: 'Population',
  chg_walk_L2_10: 'Walkability',
  chg_drive_DCF_10: 'Proximity to fast-charging',
  CIscoreP: 'CalEnviroScreen score',
  OzoneP: 'CES Ozone %',
  DieselPM_P: 'CES Diesel PM %',
  PM2_5_P: 'CES PM2.5 %',
  TrafficP: 'CES traffic proximity/volume',
  AsthmaP: 'CES asthma emerg. visits %',
  LowBirWP: 'CES low birth weight %',
  CardiovasP: 'CES cardiovascular disease %',
  EducatP: 'CES < HS education %',
  Ling_IsolP: 'Linguistic isolation %',
  PovertyP: 'Poverty %',
  UnemplP: 'CES unemployment %',
  HousBurdP: 'CES housing burden %',
  PopCharP: 'Population characteristics %',
  P_D2_PM25: 'EJScreen PM2.5 %',
  P_D2_OZONE: 'EJScreen Ozone %',
  P_D2_DSLPM: 'EJScreen Diesel PM %',
  P_D2_RSEI_AIR: 'EJScreen Toxic Releases to Air %',
  P_D2_PTRAF: 'EJScreen Traffic Proximity %',
  P_D2_NO2: 'EJScreen NO2 %',
  disadvantaged: 'Disadvantaged %',
  diesel_ex: 'CJEST diesel PM %',
  pm25: 'CJEST PM2.5 %',
  traffic: 'CJEST traffic proximity/volume',
  low_life_ex: 'Low-life expectancy %',
  heart_dis: 'CJEST cardiovascular disease %',
  house_burd: 'CJEST Housing burden',
  ling_iso: 'CJEST linguistic isolation',
  education: 'CJEST < HS education %',
  LMI: 'Low-Moderate Income',
  '100_fpl': 'Below 100% FPL',
  '200_fpl': 'Below 200% FPL',
  unemployment: 'CJEST Unemployment %',
  non_white_pctl: 'Non-white %',
  commute_pctl: 'Commute distance %',
  disability_pctl: 'Disability %',
  'Multi-Family Housing Residents': 'Multi-fam housing residents',
  Renters: 'Renters',
  lev_10000: 'Registered LEVs',
  pge: 'Line capacity (kW)',
  nevi: 'National EV program',
  irs30c: 'Alternative fuel credit',
}
